...
export default React.createClass({
  ...
  onChange: function (step) {
    this.context.router.push(`/wizard/${step}`)
  },

  next: function () {
    this.onChange(parseInt(this.props.params.step) + 1)
  },
  ...
  render: function () {
    ...
    var steps = [
      <Step key='1'>
        ...
        <Button borderless kind='primary' label='Skip' icon='chevron-right' onClick={this.next} />
      </Step>,
      ...
      <Step key='4'>
        ...
        <Button borderless kind='primary' label='Skip' icon='chevron-right' onClick={this.close} />
      </Step>
    ]

    return (
      <Overlay onClose={this.close} inverse scroll>
