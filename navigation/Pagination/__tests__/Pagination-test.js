...
describe('Pagination', function() {
  describe('default', function() {
    ...
    it('should disable the page down button', function() {
      ...
      expect(buttons[0].getDOMNode().className).to.contain('hui-Pagination__pager--disabled')
    ...
    it('should disable the page up button', function() {
      ...
      expect(buttons[1].getDOMNode().className).to.contain('hui-Pagination__pager--disabled')
    })
