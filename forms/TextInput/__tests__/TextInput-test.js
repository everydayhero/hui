...
describe('TextInput', function() {
  ...
  describe('readOnly behavior', function() {
    it('will not alter input when readOnly', function() {
      var element = renderIntoDocument(<TextInput value="oldValue" readOnly={ true } />);
    ...
    it('will not execute methods when disabled', function() {
      ...
      var element = renderIntoDocument(<TextInput value="oldValue" disabled={ true } onFocus={ onFocus } onChange={ onChange } validate={ validate } />);
      var input = findByClass(element, 'hui-TextInput__input').getDOMNode();
  ...
  describe('readOnly callbacks', function() {
    ...
    it('will execute validate function on blur if required', function() {
      ...
      var element = renderIntoDocument(<TextInput required={ true } validate={ validate } />);
      var input = findByClass(element, 'hui-TextInput__input').getDOMNode();
      element.setProps({ onChange: onChange.bind(element) });
    ...
    it('will execute validate function on load if has value', function() {
      var validate = sinon.stub();
      var element = renderIntoDocument(<TextInput required={ true } value="testValue" validate={ validate } />);
    ...
    it('will execute onBlur prop on blur', function() {
      ...
      var value = 'foo';
      var element = renderIntoDocument(<TextInput required={ true } onBlur={ onBlur }  value={ value }/>);
      var input = findByClass(element, 'hui-TextInput__input').getDOMNode();
    ...
    it('will execute onBlur prop on blur', function() {
      var onTab = sinon.spy();
      var value = 'foo';
      var element = renderIntoDocument(<TextInput required={ true } onTab={ onTab }  value={ value }/>);
      var input = findByClass(element, 'hui-TextInput__input').getDOMNode();
