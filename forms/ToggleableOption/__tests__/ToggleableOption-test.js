...
describe('ToggleableOption', () => {
  ...
  it('renders with label', () => {
    ...
    ReactDOM.findDOMNode(element).textContent.should.contain(props.label)
  ...
  it('displays error message', () => {
    ...
    findByClass(element, 'ToggleableOption__error').textContent.should.contain(element.t('error_message'))
